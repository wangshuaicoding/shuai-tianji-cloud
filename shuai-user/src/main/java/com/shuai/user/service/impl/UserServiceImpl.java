...
import static com.shuai.user.constants.UserConstants.*;
import static com.shuai.user.constants.UserErrorInfo.Msg.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public void updatePasswordByPhone(String cellPhone, String code, String password) {
        ...
        // 2.查询用户
        User user = lambdaQuery().eq(User::getCellPhone, cellPhone).one();
        if (user == null) {
            // 手机号不存在
