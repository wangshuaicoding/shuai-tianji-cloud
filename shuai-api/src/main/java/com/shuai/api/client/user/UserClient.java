package com.shuai.api.client.user;
...
@FeignClient(contextId = "remoteUserService", value = ServiceNameConstants.USER_SERVICE, fallbackFactory = UserClientFallback.class)
public interface UserClient {
    ...
    R<LoginUserDTO> queryUserDetail(@RequestBody LoginFormDTO loginDTO, @PathVariable("isStaff") boolean isStaff);
