...
import com.shuai.common.exceptions.ForbiddenException;
import com.shuai.common.exceptions.UnauthorizedException;
...
import static com.shuai.common.constants.AuthErrorInfo.Code.EXPIRED_TOKEN_CODE;
import static com.shuai.common.constants.AuthErrorInfo.Code.INVALID_TOKEN_CODE;
import static com.shuai.common.constants.AuthErrorInfo.Msg.*;
...
public class AuthUtil {
    ...
    public AuthUtil(StringRedisTemplate stringRedisTemplate) {
        ...
        this.hashOps = stringRedisTemplate.boundHashOps(JwtConstants.AUTH_PRIVILEGE_KEY);
    }
    ...
    private int currentVersion() {
        String version = stringRedisTemplate.opsForValue().get(JwtConstants.AUTH_PRIVILEGE_VERSION_KEY);
